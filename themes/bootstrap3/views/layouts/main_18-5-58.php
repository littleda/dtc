        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Datacenter Phangnga Hospital</a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <?php
                        if ((Yii::app()->session["user_typelogin"] == 'SUPERUSER') || (Yii::app()->session["user_typelogin"] == 'ADMINISTRATOR')) {
                            ?> 
...
<?php } ?>
                    ...
                    <div class="navbar-form navbar-right">
                        ...
                        if (empty(Yii::app()->session["userlogin"])) {
                            ...
                            <?php echo Yii::app()->session["fullname"] ?> </p> <!-- สร้างปุ่มชื่อนามสกุล เมื่อ login -->
        ...
        <div class="container-fluid" role="main">
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar" id="accordion">
                    ...
                    <ul class="nav nav-sidebar">
                        <li href="#KPI" aria-expanded="false" data-toggle="collapse" aria-controls="KPI" data-parent="#accordion"><a href="#" >KPI</a></li>                      
                    </ul>
                    <ul class="collapse"  id="KPI">
                        <li><a href="#">ดัชนีชี้วัดการตรวจราชการประจำปี</a></li>
                        <li><a href="#">ดัชนีชี้วัด Service Plan 12 สาขา</a></li>
                        <li><a href="https://docs.google.com/spreadsheets/d/1_YP9yLeHE6HIzYuQV9a4gkgaWRSL6Mm_qzHSQu5qFjQ/edit?usp=sharing" target="_blank">KPI Template</a></li>
                    ...
                    <ul class="nav nav-sidebar">
                        <li><a href="#Health_Status" aria-expanded="false" data-toggle="collapse" aria-controls="Health_Status" data-parent="#accordion">ข้อมูลสถานะสุขภาพ</a></li>
                    </ul>
                    <ul class="collapse"  id="Health_Status">
                        <li><a href="http://www.pngo.moph.go.th/phangnga/index.php/2014-02-20-06-43-01/96-pnho/data-content/population/76" target="_blank">ข้อมูลประชากร</a></li>
                        <li><a href="http://www.pngo.moph.go.th/phangnga/index.php/2014-02-20-06-43-01/116-pnho/data-content/health-status/81" target="_blank">ข้อมูลสถิติชีพ</a></li>
                        <li><a href="http://www.pngo.moph.go.th/phangnga/index.php/2014-02-20-06-43-01/116-pnho/data-content/health-status/82" target="_blank">ข้อมูลการป่วย</a></li>                       
                    </ul>
                    <!--                    <ul class="nav nav-sidebar">
                    ...
                    <ul class="nav nav-sidebar">
                        <li><a href="#Web_Link" aria-expanded="false" data-toggle="collapse" aria-controls="Web_Link" data-parent="#accordion">Web Link</a></li>
                    </ul>                
