...
<!--                             <ul class="nav navbar-nav navbar-right btn-success">
        ...
        <div class="container-fluid" role="main" style="min-height: 635px;">
                ...
                <section class="col-sm-3 col-md-2 sidebar">
                    <div class="nav nav-sidebar panel-group" id="accordion">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a  href="index.php"><i class="glyphicon glyphicon-chevron-right"></i> หน้าหลัก</a>
                                </h4>
                            </div>                           
                        </div>
                        <div class="panel panel-default"   >
                            <div class="panel-heading" >
                                <h4 class="panel-title">
                                    <a  href="<?php echo Yii::app()->baseUrl; ?>/doc/year_report.pdf" target="_blank"><i class="glyphicon glyphicon-chevron-right"></i> รายงานประจำปี</a>
                                </h4>
                            </div>                           
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a  href="<?php echo Yii::app()->baseUrl; ?>/doc/hospital_profile.pdf" target="_blank"><i class="glyphicon glyphicon-chevron-right"></i> Hospital Profile</a>
                                </h4>
                            </div>                           
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse0"><i class="glyphicon glyphicon-chevron-right"></i> ข้อมูลสถิติทางการแพทย์</a>
                                </h4>
                            </div>
                            <div id="collapse0" class="panel-collapse collapse">
                                ...
                                <div class="panel-body"><a href="index.php?r=report/topdiseasefirstIPD" >โรคหลักที่พบบ่อยในผู้ป่วยใน</a></div>
                                <div class="panel-body"><a href="index.php?r=report/topdeadIPD" >โรคที่พบจากการเสียชีวิต</a></div> 
                                <div class="panel-body"><a href="index.php?r=report/topdisease" >โรค</a></div>
                            </div>                    
                        </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"><i class="glyphicon glyphicon-chevron-right"></i> KPI</a>
                                </h4>
                            </div>
...
<!--                                <div class="panel-body"><a href="<?php //echo Yii::app()->theme->baseUrl;                                        ?>/doc/indicator.xlsx" target="_blank">ดัชนีชี้วัดคุณภาพทีมนำพัฒนาคุณภาพโรงพยาบาล</a></div>-->
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse2"><i class="glyphicon glyphicon-chevron-right"></i> ข้อมูลสถานะสุขภาพ</a>
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse3"><i class="glyphicon glyphicon-chevron-right"></i> Web Link</a>
                                </h4>
                            </div>
