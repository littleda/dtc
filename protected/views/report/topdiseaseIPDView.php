...
<div class="page-header">
    <h1 class="panel-title"><?php echo CHtml::image('images/report.png'); ?> รายงานโรคที่พบบ่อยในผู้ป่วยใน</h1>
</div>
<?php
...
WHERE  (date_format(DIP.D_UPDATE, '%Y-%m-%d')) >= '$str_date' AND (date_format(DIP.D_UPDATE, '%Y-%m-%d')) <= '$end_date'
...
Yii::app()->clientScript->registerScript('JS', "
        $('#chart_container').highcharts({
            ...
            title: {
                text: 'กราฟแสดง อันดับโรคที่พบบ่อยในผู้ป่วยใน'
            },
//            subtitle: {
